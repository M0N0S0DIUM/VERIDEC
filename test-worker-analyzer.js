...
/**
 * Simple test script for VERIDEC workers-friendly-analyzer
 */

const { analyzeCode, ISSUE_CATEGORIES } = require('./src/workers-friendly-analyzer.js');
...
`;
  ...
  const aiCode = `
// Placeholder implementation - example code for demonstration
